...
// Listing 4-8: Storing the result from calling the first_word 
...
// Listing 4-9: Improving the first_word function by using a string 
// slice for the type of the s parameter
